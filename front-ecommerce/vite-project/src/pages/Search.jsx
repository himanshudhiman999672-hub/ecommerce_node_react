const Search = () =>{
    ...
    <section class="band">
      <div class="mx-auto max-w-7xl px-5">
        <p class="text-sm font-black uppercase tracking-normal text-emerald-700">Search</p>
        <div class="mt-2 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <h1 class="max-w-3xl text-4xl font-black leading-tight md:text-6xl">Find products</h1>

        </div>
      </div>
      <form class="mx-auto mt-8 max-w-4xl px-5 panel"><input placeholder="Search bags, headphones, home decor" /><a
          class="btn-dark mt-3" href="products.html">Search</a></form>
