const Product = () =>{
    ...
    <section class="band">
      <div class="mx-auto max-w-7xl px-5">
        <p class="text-sm font-black uppercase tracking-normal text-emerald-700">Shop</p>
        <div class="mt-2 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <h1 class="max-w-3xl text-4xl font-black leading-tight md:text-6xl">All products</h1>
          <p class="max-w-xl text-base leading-7 text-zinc-600">A complete product listing page with cards, prices,
            categories, and cart links.</p>
        </div>
      </div>
